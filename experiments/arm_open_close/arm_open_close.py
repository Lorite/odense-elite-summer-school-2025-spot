...
def stand_extend_arm_then_sit(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        # Wrist to tool transforms
        wrist_tform_tool_neutral = SE3Pose(x=0.25, y=0.0, z=0.0, rot=Quat())
        wrist_tform_tool_down = SE3Pose(x=0.25, y=0.0, z=0.0, rot=Quat(w=0.7071, x=0.0, y=-0.7071, z=0.0))
        ...
        # Rotate gripper downward while holding extension
